...
int main(int argc, char **argv) {
   std::cout << RED   << "sciapilinux.cpp, Copyright (c) 2023 Vilmar Catafesta <vcatafesta@gmail.com>\n" << RESET << '\n';
   ...
   qout("main()\n" );
   qout("chrx(65)       => ", chrx(a), '\n');
   qout("chrx(asc('A')) => ", chrx(asc(c)), '\n');
   qout("asc('A')       => ", asc(c), '\n');
   qout("asc(chrx(65))  => ", asc(chrx(a)), '\n');
   qout("sizeof(a)      => ", sizeof(a), '\n');
   qout("sizeof(b)      => ", sizeof(b), '\n');
   qout("sizeof(c)      => ", sizeof(c), '\n');
