...
class TimeUpdater(Gtk.Window):
    ...
    def show_message(self, message):
        ...
        self.hour_spinner.set_value(current_time.hour)
        self.minute_spinner.set_value(current_time.minute)
        ...
        # Forçar a interface a redesenhar o calendário
        self.calendar.queue_draw()  # Força o redesenho do calendário
        ...
        # Forçar a interface a redesenhar o ComboBox de timezones
        self.timezone_combobox.queue_draw()  # Força o redesenho do ComboBox
