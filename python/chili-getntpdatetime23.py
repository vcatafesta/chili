...
class DateComponent:
    def __init__(self):
        ...
        # Caixa para o quadro Raised
        self.frame = Gtk.Frame()
        self.frame.set_shadow_type(Gtk.ShadowType.IN)
        self.frame.add(self.box)

        # Label para "Data Atual" no canto esquerdo
        self.label = Gtk.Label(label="Data Atual")
        self.label.set_xalign(0)
        self.box.pack_start(self.label, False, False, 0)

        # Label para mostrar o valor da data
...
class TimeComponent:
    def __init__(self):
        ...
        # Label para "Hora Atual" no canto esquerdo
        self.label = Gtk.Label(label="Hora Atual")
        self.label.set_xalign(0)
        self.box.pack_start(self.label, False, False, 0)

        # Label para mostrar o valor da hora
        self.value_label = Gtk.Label()
...
class TimeUpdater(Gtk.Window):
    def __init__(self):
        ...
        vbox.pack_start(self.date_component.frame, False, False, 10)
        # Empacota o componente de hora
        vbox.pack_start(self.time_component.frame, False, False, 10)
