    ...
    def update_time(self, widget):
        ...
        if selected_timezone:
            ...
            try:
                ...
                # Captura o status do timedatectl
                timedatectl_output = subprocess.check_output(["timedatectl", "status"]).decode("utf-8")
                
                # Exibe a mensagem com o resultado do timedatectl
