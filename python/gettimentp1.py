...
class TimeUpdater(Gtk.Window):
    def __init__(self):
        ...
        # Botão para atualizar via NTP (ou data/hora manual)
    ...
    def format_value_callback(self, spin_button):
        """
        Callback do sinal "output" do SpinButton para forçar a exibição com 2 dígitos.
        """
    ...
    def on_search_activate(self, entry):
        """
        Callback quando o usuário pressiona Enter na caixa de busca.
        Procura um timezone que contenha o texto buscado e o seleciona.
        """
    ...
    def update_time(self, widget):
        """
        Atualiza o timezone e data/hora.
        Este exemplo atualiza o timezone via timedatectl e a data/hora via date.
        """
