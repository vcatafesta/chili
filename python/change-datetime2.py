...
class TimeUpdater(Gtk.Window):
    def __init__(self):
        ...
        self.hour_adjustment = Gtk.Adjustment(value=0, lower=0, upper=23, step_increment=1)
        ...
        self.minute_adjustment = Gtk.Adjustment(value=0, lower=0, upper=59, step_increment=1)
    ...
    def update_timezone(self):
        ...
        self.timezone_label.set_text(f"Timezone: {timezone}")
