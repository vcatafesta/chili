...
func ProcessOutput(output string) {
	...
	// Criar um PackageData com a chave raiz baseada em packageInfo.Name
	packageName := packageInfo.Name
	packageData := map[string]PackageInfo{packageName: packageInfo}
	...
	encoder.SetIndent("", "    ")
	if err := encoder.Encode(packageData); err != nil {
