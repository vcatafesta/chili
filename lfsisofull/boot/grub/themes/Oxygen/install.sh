...
# Theme Author: Legendary Bibo

# Set variables
Theme_Name="Oxygen"		# The theme will be installed in a dir with this name. Avoid spaces.
Theme_Definition_File="theme.txt"	# Filename of theme definition file.
Theme_Resolution="1024x768"		# The resolution the theme was designed to show best at, 640x480, 1024x768 etc,
